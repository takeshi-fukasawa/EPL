...
%% Comparison of EPL-analytical, EPL-krylov, and EPL-JF
            ...
            difference_cepl_table=log10([[mean(difference_cepl_krylov(:));std(difference_cepl_krylov(:))],...
                [mean(difference_cepl_JF(:));std(difference_cepl_JF(:))]]);

            difference_1epl_JF=abs(bmat_1epl_JF-bmat_1epl_analytical);
            difference_1epl_krylov=abs(bmat_1epl_krylov-bmat_1epl_analytical);
            difference_1epl_table=log10([[mean(difference_1epl_krylov(:));std(difference_1epl_krylov(:))],...
                [mean(difference_1epl_JF(:));std(difference_1epl_JF(:))]]);

            difference_2epl_JF=abs(bmat_2epl_JF-bmat_2epl_analytical);
            difference_2epl_krylov=abs(bmat_2epl_krylov-bmat_2epl_analytical);
            difference_2epl_table=log10([[mean(difference_2epl_krylov(:));std(difference_2epl_krylov(:))],...
                [mean(difference_2epl_JF(:));std(difference_2epl_JF(:))]]);

            difference_3epl_JF=abs(bmat_3epl_JF-bmat_3epl_analytical);
            difference_3epl_krylov=abs(bmat_3epl_krylov-bmat_3epl_analytical);
            difference_3epl_table=log10([[mean(difference_3epl_krylov(:));std(difference_3epl_krylov(:))],...
                [mean(difference_3epl_JF(:));std(difference_3epl_JF(:))]]);
...
table1=[[NaN;NaN],[mean(log_diff(:));std(log_diff(:))]];
